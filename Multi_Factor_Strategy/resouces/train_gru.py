...
if __name__ == '__main__':
    for mm in range(1, 2):
        ...
        os.makedirs(f'model_GRU/{mm}/', exist_ok=True)
        cur_file_path = __file__
        记得改格式
        # cur_file_name = cur_file_path.split('\\')[-1]
        cur_file_name = cur_file_path.split('/')[-1]
        shutil.copyfile(cur_file_path, f'model_GRU/{mm}/{cur_file_name}')
        ...
        for end in end_list:
            ...
            fig.savefig(f'model_GRU/{mm}/{end}.png')
